...
echo ========================================================================
echo =                                                                      =
echo =     Downloading  139  cores  (nightly) for 64-bit RetroArch          =
echo =                                                                      =
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/beetledc_libretro.dll.zip -O "%rkdir%\Temp\cores\6.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/beetle-dc_libretro.dll.zip -O "%rkdir%\Temp\cores\7.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/beetledc_wince_libretro.dll.zip -O "%rkdir%\Temp\cores\8.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/beetle-dc_wince_libretro.dll.zip -O "%rkdir%\Temp\cores\9.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/desmume2015_libretro.dll.zip -O "%rkdir%\Temp\cores\29.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/fbalpha2012_cps1_libretro.dll.zip -O "%rkdir%\Temp\cores\41.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/fbalpha2012_cps2_libretro.dll.zip -O "%rkdir%\Temp\cores\42.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/fbalpha2012_libretro.dll.zip -O "%rkdir%\Temp\cores\43.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/fbalpha2012_neogeo_libretro.dll.zip -O "%rkdir%\Temp\cores\44.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/fbneo_libretro.dll.zip -O "%rkdir%\Temp\cores\45.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/fceumm_libretro.dll.zip -O "%rkdir%\Temp\cores\46.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/ffmpeg_libretro.dll.zip -O "%rkdir%\Temp\cores\47.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mame_libretro.dll.zip -O "%rkdir%\Temp\cores\65.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mame2000_libretro.dll.zip -O "%rkdir%\Temp\cores\66.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mame2003_libretro.dll.zip -O "%rkdir%\Temp\cores\67.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mame2003_plus_libretro.dll.zip -O "%rkdir%\Temp\cores\68.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mame2010_libretro.dll.zip -O "%rkdir%\Temp\cores\69.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mame2015_libretro.dll.zip -O "%rkdir%\Temp\cores\70.zip"

%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mame2016_libretro.dll.zip -O "%rkdir%\Temp\cores\71.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_pcfx_libretro.dll.zip -O "%rkdir%\Temp\cores\76.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_psx_hw_libretro.dll.zip -O "%rkdir%\Temp\cores\77.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_psx_libretro.dll.zip -O "%rkdir%\Temp\cores\78.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_saturn_libretro.dll.zip -O "%rkdir%\Temp\cores\79.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_snes_libretro.dll.zip -O "%rkdir%\Temp\cores\80.zip"

%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_supergrafx_libretro.dll.zip -O "%rkdir%\Temp\cores\81.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_vb_libretro.dll.zip -O "%rkdir%\Temp\cores\82.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mednafen_wswan_libretro.dll.zip -O "%rkdir%\Temp\cores\83.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/melonds_libretro.dll.zip -O "%rkdir%\Temp\cores\84.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mupen64plus_libretro.dll.zip -O "%rkdir%\Temp\cores\91.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/mupen64plus_next_libretro.dll.zip -O "%rkdir%\Temp\cores\92.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/nekop2_libretro.dll.zip -O "%rkdir%\Temp\cores\93.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/nestopia_libretro.dll.zip -O "%rkdir%\Temp\cores\94.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/np2kai_libretro.dll.zip -O "%rkdir%\Temp\cores\95.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/nxengine_libretro.dll.zip -O "%rkdir%\Temp\cores\96.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/o2em_libretro.dll.zip -O "%rkdir%\Temp\cores\97.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/openlara_libretro.dll.zip -O "%rkdir%\Temp\cores\98.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/parallel_n64_libretro.dll.zip -O "%rkdir%\Temp\cores\99.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/pcsx_rearmed_libretro.dll.zip -O "%rkdir%\Temp\cores\100.zip"

%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/picodrive_libretro.dll.zip -O "%rkdir%\Temp\cores\101.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/snes9x_libretro.dll.zip -O "%rkdir%\Temp\cores\116.zip"
...
echo ========================================================================
echo =                                                                      =
echo =     Downloading  139  cores  (nightly) for 32-bit RetroArch          =
echo =                                                                      =
echo =     This will take some time...                                      =
echo =                                                                      =
echo ========================================================================
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/beetledc_libretro.dll.zip -O "%rkdir%\Temp\cores\6.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/beetle-dc_libretro.dll.zip -O "%rkdir%\Temp\cores\7.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/beetledc_wince_libretro.dll.zip -O "%rkdir%\Temp\cores\8.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/beetle-dc_wince_libretro.dll.zip -O "%rkdir%\Temp\cores\9.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/desmume2015_libretro.dll.zip -O "%rkdir%\Temp\cores\29.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/fbalpha2012_cps1_libretro.dll.zip -O "%rkdir%\Temp\cores\41.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/fbalpha2012_cps2_libretro.dll.zip -O "%rkdir%\Temp\cores\42.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/fbalpha2012_libretro.dll.zip -O "%rkdir%\Temp\cores\43.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/fbalpha2012_neogeo_libretro.dll.zip -O "%rkdir%\Temp\cores\44.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/fbneo_libretro.dll.zip -O "%rkdir%\Temp\cores\45.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/fceumm_libretro.dll.zip -O "%rkdir%\Temp\cores\46.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/ffmpeg_libretro.dll.zip -O "%rkdir%\Temp\cores\47.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mame_libretro.dll.zip -O "%rkdir%\Temp\cores\65.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mame2000_libretro.dll.zip -O "%rkdir%\Temp\cores\66.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mame2003_libretro.dll.zip -O "%rkdir%\Temp\cores\67.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mame2003_plus_libretro.dll.zip -O "%rkdir%\Temp\cores\68.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mame2010_libretro.dll.zip -O "%rkdir%\Temp\cores\69.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mame2015_libretro.dll.zip -O "%rkdir%\Temp\cores\70.zip"

%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mame2016_libretro.dll.zip -O "%rkdir%\Temp\cores\71.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_pcfx_libretro.dll.zip -O "%rkdir%\Temp\cores\76.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_psx_hw_libretro.dll.zip -O "%rkdir%\Temp\cores\77.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_psx_libretro.dll.zip -O "%rkdir%\Temp\cores\78.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_saturn_libretro.dll.zip -O "%rkdir%\Temp\cores\79.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_snes_libretro.dll.zip -O "%rkdir%\Temp\cores\80.zip"

%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_supergrafx_libretro.dll.zip -O "%rkdir%\Temp\cores\81.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_vb_libretro.dll.zip -O "%rkdir%\Temp\cores\82.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mednafen_wswan_libretro.dll.zip -O "%rkdir%\Temp\cores\83.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/melonds_libretro.dll.zip -O "%rkdir%\Temp\cores\84.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mupen64plus_libretro.dll.zip -O "%rkdir%\Temp\cores\91.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/mupen64plus_next_libretro.dll.zip -O "%rkdir%\Temp\cores\92.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/nekop2_libretro.dll.zip -O "%rkdir%\Temp\cores\93.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/nestopia_libretro.dll.zip -O "%rkdir%\Temp\cores\94.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/np2kai_libretro.dll.zip -O "%rkdir%\Temp\cores\95.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/nxengine_libretro.dll.zip -O "%rkdir%\Temp\cores\96.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/o2em_libretro.dll.zip -O "%rkdir%\Temp\cores\97.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/openlara_libretro.dll.zip -O "%rkdir%\Temp\cores\98.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/parallel_n64_libretro.dll.zip -O "%rkdir%\Temp\cores\99.zip"
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/pcsx_rearmed_libretro.dll.zip -O "%rkdir%\Temp\cores\100.zip"

%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/picodrive_libretro.dll.zip -O "%rkdir%\Temp\cores\101.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/snes9x_libretro.dll.zip -O "%rkdir%\Temp\cores\116.zip"
