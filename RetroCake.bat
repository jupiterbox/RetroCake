...
cls
echo A fork of Flerp/RetroCake v1.4.5     Modified date: May 29, 2019
echo ===========================================================================
echo =                                                                         =
...
echo     ^<extension^>.zip .ZIP^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>C:\RetroCake\RetroArch\retroarch.exe -L C:\RetroCake\RetroArch\cores\mame_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86_64/latest/fbneo_libretro.dll.zip -O "%rkdir%\Temp\cores\137.zip"
...
%rkdir%\Tools\Wget\wget.exe -q --show-progress http://buildbot.libretro.com/nightly/windows/x86/latest/fbneo_libretro.dll.zip -O "%rkdir%\Temp\cores\137.zip"
