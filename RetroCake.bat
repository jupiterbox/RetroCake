...
echo     ^<fullname^>Tandy Color Computer^</fullname^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<fullname^>TI-99/4A^</fullname^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
