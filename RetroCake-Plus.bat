...
echo     ^<extension^>.7z .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath %rkdir%\ROMS\arcade\mame\ "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .fba .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.daphne^</extension^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.cdi .chd .gdi .lst .zip .7z^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .cpr .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath %rkdir%\ROMS\console\gx4000\ gx4000 -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll gx4000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .a26 .bin .gz .rom .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .a52 .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .a78 .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .j64 .jag .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .chd .cue .iso .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\virtualjaguar_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\console-keypad\astrocade\ astrocde -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .col .rom .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .cue .iso .lha^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath %rkdir%\ROMS\console\pv-1000\ pv1000 -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll pv1000 -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\console-keypad\arcadia\ arcadia -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\console-keypad\supercassettevision\ scv -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll scv -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath %rkdir%\ROMS\console\channel-f\ channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll channelf -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath %rkdir%\ROMS\console\super-acan\ supracan -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll supracan -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .int .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.iso^</extension^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\Emulators\Xemu\xemu.exe -full-screen -dvd_path "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .pce .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>tg16-usa-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>pcengine-japan-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .cue .chd .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mednafen_pce_fast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>tg16cd-usa-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>pce-cd-japan-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>pcenginecd^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<theme^>pcenginecd-japan-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .cue .chd .pce .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .nes .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>nes-usa-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>famicom-japan-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .fds .nes .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\fceumm_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .bs .fig .mgd .sfc .smc .swc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>snes-usa-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>sfc-usa-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .gb .gbc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bs .sfc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .sfc .st .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .n64 .v64 .z64 .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .d64 .ndd .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mupen64plus_next_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .gcz .iso .rpx .wad .wbfs^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .gcz .iso .rpx .wad .wbfs .zip .7z^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\dolphin_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\Emulators\Dolphin\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\Emulators\Dolphin-dev\Dolphin.exe -e "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.iso .rpx .wud .wux^</extension^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .iso^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .st2 .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\console-keypad\rca-studio-ii\ studio2 -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll studio2 -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .sg .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .sms .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>mastersystem-usa-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>markiii-japan-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .gen .md .sg .smd .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>genesis-usa-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<theme^>megadrive-japan-batocera^</theme^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo   ^</system^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .cue .iso^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .32x .bin .md .smd .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .cue .iso .mdf^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.cdi .chd .gdi .zip .7z^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\flycast_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.zip .7z^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\fbneo_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .cue^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.chd .gz .img .iso^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .lnx .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .ws .wsc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\portable\gamemaster\ gmaster -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll gmaster -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .smc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\portable\gp32\ gp32 -memc "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .gb .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .gbc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\gambatte_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .gba .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mgba_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .min .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .nds .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .3ds .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.nsp .xci^</extension^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .gg .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .ngp .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .ngc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mednafen_ngp_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.cso .iso .pbp^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .tgc .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\portable\gamecom\ gamecom -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll gamecom -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\portable\megaduck\ gb -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll gb -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .sv .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\potator_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\portable\supervision\ svision -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\specialty\adventurevision\ advision -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg" 
...
echo     ^<extension^>.chd .cueE^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bin .gam .vec .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .chd .cue .img .iso .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.mgw^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .vb .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .chd .cue .iso .pce .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mednafen_pce_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.msu .sfc^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\snes9x_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.game^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.exe^</extension^> >> --^> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.lutro^</extension^> >> --^> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.bat^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>"%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<extension^>.pak^</extension^> >> --^> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\ppsspp_libretro.dll "%%ROM_RAW%%"^</command^> >> --^> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .tic .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .ssd .dsd .ad .img^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\BeebEm\BeebEm.exe "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> >> --^> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\computer\bbcmicro\ bbcb -cass OR -flop "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .cdt .cpc .dsk^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\cap32_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .dsk^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .dsk .img .rom^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .bas .bin .car .com .xex .atr .xfd .dcm .atr.gz .xfd.gz^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\atari800_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .st .stx .img .rom .raw .ipf .ctr^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .bas .bin .col .com .ddp .dsk .img .lbr .rom .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .crt .d64 .g64 .t64 .tap .x64 .zip .prg^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.adf .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\puae_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .bin^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\computer\aquarius\ aquarius -cart "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll aquarius -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .rom .mx1 .mx2 .col .dsk .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\bluemsx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .sg^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\genesis_plus_gx_libretro.dll "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .d88 .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<!-- ^<command^>%rkdir%\Emulators\mame\mame.exe -rompath C:\RetroCake-Plus\ROMS\computer\x1\ x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll x1 -cart "%%ROM_RAW%%"^</command^> --^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .dim .m3u .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .sh .sna .szx .z80 .tap .tzx .gz .udi .mgt .img .trd .scl .dsk .zip^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.7z .zip .cas .wav .bas .asc .dmk .jvc .os9 .dsk .vdk .rom .ccc .sna^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
echo     ^<extension^>.zip .bin^</extension^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<command^>%rkdir%\Emulators\Classic99\classic99.exe -rom "%%ROM_RAW%%"^</command^> >> "%USERPROFILE%\.emulationstation\es_systems.cfg"
echo     ^<!-- ^<command^>%rkdir%\RetroArch\retroarch.exe -L %rkdir%\RetroArch\cores\mame_libretro.dll ti99_4a -cart "%%ROM_RAW%%"^</command^> >> --^> "%USERPROFILE%\.emulationstation\es_systems.cfg"
...
powershell -command Start-BitsTransfer -Source https://www.ppsspp.org/files/1_11_3/ppsspp_win.zip -Destination "%rkdir%\Temp\ppsspp.zip"
...
powershell -command Start-BitsTransfer -Source https://www.6809.org.uk/xroar/dl/xroar-0.36.2-w64.zip -Destination "%rkdir%\Temp\XRoar64.zip"
